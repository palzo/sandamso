...
import com.example.sansaninfo.databinding.ListTalkItemOthersBinding
...
class ChattingMsgAdapter(
    ...
    val recyclerView = (context as ChattingPageActivity).recycler_talks   //목록이 표시될 리사이클러 뷰
